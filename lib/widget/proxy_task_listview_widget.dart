              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Text('有${homeProxyModel.data.urgeCount}项任务已升级到区总，需要您尽快处理！',
      ...
      builder: (context,child,data){
        ...
        if(homeProxyModel != null && homeProxyModel.code == '0000'){
          ...
          if(cateList.length>0){
            return Container(
              height: ScreenUtil().setHeight(417.0),
              child: EasyRefresh(
                onRefresh: () async {
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      _upgradeOrSuperviseUI('${item.upgradeCount}', '升级', WMColors.themeDangerColor),
                      _upgradeOrSuperviseUI(distributerType==0?'${item.totalCount}':'${item.taskCategory}', distributerType==0?'待办':'督办', Color.fromRGBO(34, 34, 34, 1.0)),
                    ],
                  )
                ],
              ),
